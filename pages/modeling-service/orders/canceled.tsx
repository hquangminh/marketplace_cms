...
const Index = () => {
  ...
  return (
    <>
      <Head>
        <title>Market Place Admin - Modeling Service Order - Canceled</title>
      </Head>

      <>
        <HeaderPageFragment title='Modeling Service Order - Canceled' />
...
export default withAuth(
  withLayout(Index, {
    sidebar: {
      ...
      selectedKey: 'modeling-service-order-canceled',
    },
  })
);
