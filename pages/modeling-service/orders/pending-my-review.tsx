...
const Index = () => {
    ...
    const onFetchOrder = async () => {
      ...
      try {
        const resp = await orderServices.getAllOrders({
          ...
          params: { status: 6, sort_type: 'asc', sort_by: 'estimated_time' },
        });
  ...
  return (
    <>
      <Head>
        <title>Market Place Admin - Modeling Service Order - Pending my review</title>
      </Head>

      <>
        <HeaderPageFragment title='Modeling Service Order - Pending my review' />
...
export default withAuth(
  withLayout(Index, {
    sidebar: {
      ...
      selectedKey: 'modeling-service-order-pending-my-review',
    },
  })
);
