...
const Index = (props: PropsPageType) => {
  ...
  return (
    <Fragment>
      <Head>
        <title>Market Place Admin - View Product </title>
      </Head>

      <HeaderPageFragment title='View Product' breadcrumb={[{ title: 'Products', path: urlPage.productNewest }, { title: productDetail?.title || '' }]} />
